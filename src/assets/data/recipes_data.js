...
export const recipesData = [
  ...
  },
  {
    ...
    time: "90m",
    effects: "When consumed, the drinker Gains 3 Verve",
  ...
  },
  {
    ...
    time: "120m",
    effects:
      "When introduced to the bloodstream by mouth or wound, inflicts a WIS and CON Debility, and applies 1 Verve Loss per round for 12 rounds.",
  ...
  },
  {
    ...
    time: "120m",
    effects:
      "When introduced to the bloodstream by mouth or wound, inflicts a INT and STR Debility, and applies 1 Verve Loss per round for 12 rounds.",
  ...
  },
  {
    ...
    reagents: [ReagentProperties.Oil, ReagentProperties.For],
    dc: 1,
  },
  {
    type: "Applicant",
    ...
    reagents: [ReagentProperties.Exc, ReagentProperties.For, ReagentProperties.The],
    dc: 2,
  },
  {
    type: "Applicant",
    ...
    time: "30m",
    effects: "When applied to a weapon coated in Oilstick, adds d6 Cryal damage to the next 3 attacks with the weapon.",
    reagents: [ReagentProperties.Exc, ReagentProperties.For, ReagentProperties.Hyd],
    dc: 2,
  },
  {
    type: "Applicant",
    ...
    reagents: [ReagentProperties.Exc, ReagentProperties.For, ReagentProperties.Exc],
    dc: 2,
  },
  {
    type: "Potion",
    ...
    time: "0m",
    effects: "When consumed, Restores 1 Verve.",
  ...
  },
  {
    ...
    time: "60m",
    effects:
      "When applied to the skin and clothing, reduces the effects of heat, fire and Radiant.  Any Verve Loss caused by Fire or Radiant energy is reduced by 2 and any negatives applied to rolls due to fire are halved.  Lasts 2 hours.",
  ...
  },
  {
    ...
    time: "60m",
    effects:
      "When applied to the skin and clothing, reduces the effects of lightning and acid.  Any Verve Loss caused by Lightning or Acid energy is reduced by 2.  Lasts 2 hours.",
  ...
  },
  {
    ...
    time: "60m",
    effects:
      "When applied to the skin and clothing, reduces the effects of cold and wind.  Any Verve Loss caused by Sound or Wind energy is reduced by 2 and any negatives applied to rolls due to cold are halved.  Lasts 2 hours.",
  ...
  },
  {
    ...
    reagents: [ReagentProperties.Exc, ReagentProperties.Exc, ReagentProperties.For, ReagentProperties.The],
    dc: 5,
  },
  {
    type: "Misc",
